	   ...
	   <div class="wrapper">
		   ...
		   <div class="formcontent">
		        <div class="workcontent">
			      <div class="texttip">拜访对象：</div>
				  <div class="content">{{reportdetail.object}}</div>
			    </div>
			    <div class="workcontent">
			      <div class="texttip">拜访方式：</div>
			      <div class="content">{{reportdetail.type1}}</div>
			    </div>
			    <div class="workcontent">
			      <div class="texttip">商务阶段：</div>
			      <div class="content">{{reportdetail.stage1}}</div>
			    </div>
			    <div class="workcontent">
			      <div class="texttip">拜访目的：</div>
			      <div class="content">{{reportdetail.purpose}}</div>
			    </div>  
			    <div class="workcontent">
			      <div class="texttip">拜访过程摘要：</div>
			      <div class="content">{{reportdetail.process}}</div>
			    </div>
			    <div class="workcontent">
			      <div class="texttip">洽谈成果总结：</div>
			      <div class="content">{{reportdetail.summary}}</div>
			    </div>
			    <div class="workcontent">
			      <div class="texttip">成果判断：</div>
			      <div class="content">{{reportdetail.result1}}</div>
			    </div>
			    <div class="workcontent">
			      <div class="texttip">陪同成员：</div>
			      <div class="content">{{reportdetail.member}}</div>
			    </div>
			    <div class="workcontent">
			      <div class="texttip">预计下次拜访时间：</div>
			      <div class="content">{{reportdetail.nextVisitTime}}</div>
			    </div>
			    <div class="workcontent">
			      <div class="texttip">下次拜访目的：</div>
			      <div class="content">{{reportdetail.nextVisitPurpose}}</div>
			    </div>
			    <div class="workcontent">
	...
	methods:{
		...
		dandudata (){
	        ...
	        this.$ajax.post(this.baseurl+'report/getmyinfo',qs.stringify(params)).then((res)=>{
	        	...
	        	//把select对应的value转换成中文显示
			switch (this.reportdetail.type)
				{
					case 0:
						this.$set(this.reportdetail,'type1','当面拜访');
						break;
					case 1:
						this.$set(this.reportdetail,'type1','电话拜访');
						break;
					case 2:
						this.$set(this.reportdetail,'type1','聊天软件拜访');
						break;
					case 3:
						this.$set(this.reportdetail,'type1','其他');
						break;
				}
				switch (this.reportdetail.stage)
				{
					case 0:
						this.$set(this.reportdetail,'stage1','初步洽谈无意向');
						break;
					case 1:
						this.$set(this.reportdetail,'stage1','意向洽谈明确意向');
						break;
					case 2:
						this.$set(this.reportdetail,'stage1','合作洽谈具体细节');
						break;
					case 3:
						this.$set(this.reportdetail,'stage1','合同洽谈合同签署');
						break;
					case 4:
						this.$set(this.reportdetail,'stage1','客户维护');
						break;
					case 5:
						this.$set(this.reportdetail,'stage1','公共关系维护');
						break;
					case 6:
						this.$set(this.reportdetail,'stage1','其他');
						break;
				}
				switch (this.reportdetail.result)
				{
					case 0:
						this.$set(this.reportdetail,'result1','达到预期');
						break;
					case 1:
						this.$set(this.reportdetail,'result1','未达到预期');
						break;
					case 2:
						this.$set(this.reportdetail,'result1','终止合作洽谈');
						break;
				}
	        })
		},
		...
		// yulanfile (item){
		// 	window.location.href="http://ow365.cn/?i=13273&furl="+this.baseurl+item.path;
		// },
		//发送评论
		sendbtn (){
           let datas={
		...
		xiugai (){
          ...
          //根据日志类型跳转对应页面
          if(reportType==3){
          	this.$router.push({ path: '/visitreport', query:{ filltype:'modify'}})
          }
		}
	},
	//实时获取当前路由参数
