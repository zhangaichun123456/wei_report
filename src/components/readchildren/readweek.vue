	   ...
	   <div class="wrapper">
		   ...
		   <div class="formcontent">
		        <div class="workcontent">
			      <div class="texttip">本周完成工作</div>
				  <div class="content">{{reportdetail.doneWork}}</div>
			    </div>
			    <div class="workcontent">
			      <div class="texttip">本周工作总结</div>
...
export default{
	...
	methods:{
		...
		xiugai (){
          ...
          //根据日志类型跳转对应页面
          if(reportType==1){
          	this.$router.push({ path: '/weekreport', query:{ filltype:'modify'}})
          }
		}
	},
	//实时获取当前路由参数
