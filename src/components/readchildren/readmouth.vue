	   ...
	   <div class="wrapper">
		   ...
		   <div class="formcontent">
		        <div class="workcontent">
			      <div class="texttip">本月工作内容</div>
				  <div class="content">{{reportdetail.content}}</div>
			    </div>
			    <div class="workcontent">
			      <div class="texttip">本月工作总结</div>
			      <div class="content">{{reportdetail.summary}}</div>
			    </div>
			    <div class="workcontent">
			      <div class="texttip">下月工作计划</div>
			      <div class="content">{{reportdetail.plan}}</div>
			    </div>
			    <div class="workcontent">
			      <div class="texttip">意见与建议</div>
			      <div class="content">{{reportdetail.opinion}}</div>
			    </div>  
			    <div class="workcontent">
...
export default{
	...
	methods:{
		...
		xiugai (){
          ...
          //根据日志类型跳转对应页面
          if(reportType==2){
          	this.$router.push({ path: '/mouthreport', query:{ filltype:'modify'}})
          }
		}
	},
	//实时获取当前路由参数
