	   ...
	   <form>
		   <div class="formcontent">
			    <group label-width="6.5em" label-margin-right="2em" label-align="justify">
			        <x-textarea title="本周完成工作" v-model="text1" placeholder='请填写文字(必填)' autosize :rows='1'></x-textarea>
			        <x-textarea title="本周工作总结" v-model="text2" placeholder='请填写文字(必填)' autosize :rows='1'></x-textarea>
			        <selector title="自我评价" placeholder="请填写文字(必选)" v-model="zipj" :options="list"></selector>
			        <x-textarea title="下周工作计划" v-model="text3" placeholder='请填写文字' autosize :rows='1'></x-textarea>
		   ...
		   <div class="sendto">
			   	...
			   	<ul class="sendperpson">
			   	    <li v-for="(peo,index) in choosepeo2">
			   	...
			   	<ul class="sendgroup">
			   	    <li v-for="(group,index) in choosegroup2">
...
export default{
 ...
 //        })
	...
	methods:{
		...
		// 添加人员
		addpeo (){
			this.$router.push('/choosepeo2');
		},
		//点击头像删除该成员
		delchoosepeo (index){
            this.choosepeo2.splice(index,1)
            this.empid2.splice(index,1);
		},
		//添加发送的群
		addgroup (){
			this.$router.push('/choosegroup2');
		},
		//点击头像删除该群组
		delchoosegroup (index){
            this.choosegroup2.splice(index,1);
             this.groupid2.splice(index,1);
		},
		//提交周报
		submitdaily (){
			var url='';
            ...
            formData.append('userIdList', this.empid2);
            formData.append('cginfoIdList', this.groupid2);
