        ...
        <form>
         <div class="formcontent">
            <group label-width="6.5em" label-margin-right="2em" label-align="justify">
                <x-textarea title="本月工作内容" v-model="text1" placeholder='请填写文字(必填)' autosize :rows='1'></x-textarea>
                <x-textarea title="本月工作总结" v-model="text2" placeholder='请填写文字(必填)' autosize :rows='1'></x-textarea>
                <x-textarea title="下月工作计划" v-model="text3" placeholder='请填写文字' autosize :rows='1'></x-textarea>
                <x-textarea title="意见与建议" v-model="text4" placeholder='请填写文字' autosize :rows='1'></x-textarea>
         ...
         <div class="sendto">
            ...
            <ul class="sendperpson">
                <li v-for="(peo,index) in choosepeo3">
            ...
            <ul class="sendgroup">
                <li v-for="(group,index) in choosegroup3">
...
export default{
  ...
  methods:{
    ...
    judgetype (){
      ...
      if(filltype=='modify'){
        this.text1=this.reportdetail.content;
        this.text2=this.reportdetail.summary;
        this.text3=this.reportdetail.plan;
        this.text4=this.reportdetail.opinion;
    ...
    // 添加人员
    addpeo (){
      this.$router.push('/choosepeo3');
    },
    //点击头像删除该成员
    delchoosepeo (index){
        this.choosepeo3.splice(index,1);
        this.empid3.splice(index,1);
    },
    //添加发送的群
    addgroup (){
      this.$router.push('/choosegroup3');
    },
    //点击头像删除该群组
    delchoosegroup (index){
      this.choosegroup3.splice(index,1);
      this.groupid3.splice(index,1);
    },
    //提交日报
    submitdaily (){
        var url='';
        ...
        var formData = new FormData();
            ...
            formData.append('opinion', this.text4);
            formData.append('summary', this.text2);
            formData.append('plan', this.text3);
            ...
            formData.append('userIdList', this.empid3);
            formData.append('cginfoIdList', this.groupid3);
